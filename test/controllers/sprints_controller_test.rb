...
class SprintsControllerTest < ActionController::TestCase
  ...
  test "should create sprint" do
    assert_difference('Sprint.count') do
      post :create, sprint: { number: @sprint.number, deadline: @sprint.deadline, totalPoints: @sprint.totalPoints }
    end
  ...
  test "should update sprint" do
    patch :update, id: @sprint, sprint: { number: @sprint.number, deadline: @sprint.deadline, totalPoints: @sprint.totalPoints }
    assert_redirected_to sprint_path(assigns(:sprint))
  end
